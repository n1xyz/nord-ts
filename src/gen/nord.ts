...
export interface Receipt {
  ...
  kind?:
    ...
    | { $case: "liquidated"; value: Receipt_Liquidated }
...
export const Action: MessageFns<Action> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Action>, I>>(object: I): Action {
    ...
    if (
      object.kind?.$case === "pythSetWormholeGuardians" &&
    ...
    if (
      object.kind?.$case === "pythPriceFeedUpdate" && object.kind?.value !== undefined && object.kind?.value !== null
    ) {
      message.kind = { $case: "pythPriceFeedUpdate", value: Action_PythPriceFeedUpdate.fromPartial(object.kind.value) };
    }
...
export const Receipt: MessageFns<Receipt> = {
  encode(message: Receipt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.kind?.$case) {
      ...
      case "updateGuardianSetResult":
        ...
        break;
      case "liquidated":
        Receipt_Liquidated.encode(message.kind.value, writer.uint32(346).fork()).join();
        break;
      case "sessionRevoked":
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 43:
          ...
          message.kind = { $case: "liquidated", value: Receipt_Liquidated.decode(reader, reader.uint32()) };
          continue;
        case 44:
          if (tag !== 354) {
            break;
  ...
  fromJSON(object: any): Receipt {
    return {
      ...
      kind: isSet(object.err)
        ...
        ? { $case: "liquidated", value: Receipt_Liquidated.fromJSON(object.liquidated) }
  ...
  toJSON(message: Receipt): unknown {
    ...
    if (message.kind?.$case === "liquidated") {
      obj.liquidated = Receipt_Liquidated.toJSON(message.kind.value);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Receipt>, I>>(object: I): Receipt {
    ...
    if (
      object.kind?.$case === "createSessionResult" && object.kind?.value !== undefined && object.kind?.value !== null
    ) {
      message.kind = {
        $case: "createSessionResult",
    ...
    if (object.kind?.$case === "cancelOrderResult" && object.kind?.value !== undefined && object.kind?.value !== null) {
      message.kind = { $case: "cancelOrderResult", value: Receipt_CancelOrderResult.fromPartial(object.kind.value) };
    }
    ...
    if (object.kind?.$case === "insertTokenResult" && object.kind?.value !== undefined && object.kind?.value !== null) {
      message.kind = { $case: "insertTokenResult", value: Receipt_InsertTokenResult.fromPartial(object.kind.value) };
    }
    if (
      object.kind?.$case === "insertMarketResult" && object.kind?.value !== undefined && object.kind?.value !== null
    ) {
      message.kind = { $case: "insertMarketResult", value: Receipt_InsertMarketResult.fromPartial(object.kind.value) };
    }
    ...
    if (
      object.kind?.$case === "oracleSymbolFeedResult" && object.kind?.value !== undefined && object.kind?.value !== null
    ) {
      message.kind = {
        $case: "oracleSymbolFeedResult",
    ...
    if (
      object.kind?.$case === "oracleUpdateResult" && object.kind?.value !== undefined && object.kind?.value !== null
    ) {
      message.kind = { $case: "oracleUpdateResult", value: Receipt_OracleUpdateResult.fromPartial(object.kind.value) };
    }
    if (
      object.kind?.$case === "updateGuardianSetResult" &&
      object.kind?.value !== undefined &&
      object.kind?.value !== null
    ) {
      message.kind = {
    ...
    if (object.kind?.$case === "liquidated" && object.kind?.value !== undefined && object.kind?.value !== null) {
      message.kind = { $case: "liquidated", value: Receipt_Liquidated.fromPartial(object.kind.value) };
    }
...
function createBaseReceipt_Liquidated(): Receipt_Liquidated {
  return {};
}

export const Receipt_Liquidated: MessageFns<Receipt_Liquidated> = {
  encode(_: Receipt_Liquidated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Receipt_Liquidated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(_: any): Receipt_Liquidated {
    return {};
  },

  toJSON(_: Receipt_Liquidated): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<Receipt_Liquidated>, I>>(base?: I): Receipt_Liquidated {
    return Receipt_Liquidated.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Receipt_Liquidated>, I>>(_: I): Receipt_Liquidated {
    const message = createBaseReceipt_Liquidated();
    return message;
  },
};
