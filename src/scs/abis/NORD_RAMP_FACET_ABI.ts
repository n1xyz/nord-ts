export const NORD_RAMP_FACET_ABI = [{
    ...
    "inputs": [{"name": "recipient", "type": "bytes", "internalType": "bytes"}, {
        "name": "assetId",
        "type": "uint256",
    ...
    "inputs": [{
        ...
        "indexed": false,
        "internalType": "uint256"
    }, {"name": "actionNonce", "type": "uint256", "indexed": false, "internalType": "uint256"}],
    "anonymous": false
}, {
    "type": "event",
    "name": "RampWithdrawal",
    "inputs": [{"name": "user", "type": "address", "indexed": true, "internalType": "address"}, {
        ...
        "indexed": true,
        "internalType": "uint256"
    }, {"name": "quantizedAmount", "type": "uint256", "indexed": false, "internalType": "uint256"}],
    "anonymous": false
}, {
    "type": "error",
